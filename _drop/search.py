...
from drop_prompt import create_new_archive, get_prompt, get_self_reflection_prompt
...
from utils import random_id, calculate_fitness, load_drop, drop_metric
...
def evaluate_forward_fn(cmd_line_args, code_being_judged):
    ...
    print(f"f1: {calculate_fitness(score_list)}")
    return score_list
...
if __name__ == "__main__":
    ...
    parser.add_argument('--archive_name', type=str, default="drop_llama3.1_results")
